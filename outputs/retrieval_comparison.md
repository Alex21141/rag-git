...
| What is a Git branch and how do I create one? | github_about_git_chunk_002 (0.6179) | git_basics_getting_repository_chunk_000 (0.9814) | 🔄 Гібридний пошук обрав інший чанк: github_about_git_chunk_002 → git_basics_getting_repository_chunk_000 |
...
| How do I stash my changes temporarily? | git_tools_stashing_cleaning_chunk_000 (0.6251) | git_tools_stashing_cleaning_chunk_003 (0.9333) | 🔄 Гібридний пошук обрав інший чанк: git_tools_stashing_cleaning_chunk_000 → git_tools_stashing_cleaning_chunk_003 |
| How do I merge a branch in GitLab? | gitlab_getting_started_chunk_004 (0.7394) | gitlab_getting_started_chunk_003 (0.9299) | 🔄 Гібридний пошук обрав інший чанк: gitlab_getting_started_chunk_004 → gitlab_getting_started_chunk_003 |
| How do I view the commit history? | github_about_git_chunk_000 (0.5686) | github_about_git_chunk_000 (0.9040) | ✅ Топ-1 зберігся, гібридний бал вищий — BM25 підтверджує релевантність |
...
| What is rebasing and when should I use it? | git_tools_rebasing_chunk_016 (0.5640) | git_tools_rebasing_chunk_000 (0.9090) | 🔄 Гібридний пошук обрав інший чанк: git_tools_rebasing_chunk_016 → git_tools_rebasing_chunk_000 |
| How do I push changes to a remote repository? | distributed_workflows_chunk_005 (0.7193) | distributed_workflows_chunk_005 (0.9121) | ✅ Топ-1 зберігся, гібридний бал вищий — BM25 підтверджує релевантність |
...
**Baseline (HW2):** `github_about_git_chunk_002` (0.6179)
**Improved (HW3):** `git_basics_getting_repository_chunk_000` (0.9814)
...
**Baseline (HW2):** `git_tools_stashing_cleaning_chunk_000` (0.6251)
**Improved (HW3):** `git_tools_stashing_cleaning_chunk_003` (0.9333)

### Запит 6: How do I merge a branch in GitLab?

**Baseline (HW2):** `gitlab_getting_started_chunk_004` (0.7394)
**Improved (HW3):** `gitlab_getting_started_chunk_003` (0.9299)

### Запит 7: How do I view the commit history?

**Baseline (HW2):** `github_about_git_chunk_000` (0.5686)
**Improved (HW3):** `github_about_git_chunk_000` (0.9040)
...
**Improved (HW3):** `git_tools_rebasing_chunk_000` (0.9090)

### Запит 10: How do I push changes to a remote repository?

**Baseline (HW2):** `distributed_workflows_chunk_005` (0.7193)
**Improved (HW3):** `distributed_workflows_chunk_005` (0.9121)
