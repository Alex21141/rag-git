...
|-------|---------------|----------------|-------------|
| How do I clone a Git repository? | git_basics_getting_repository_chunk_006 (0.7135) | git_basics_getting_repository_chunk_006 (0.9877) | ✅ Топ-1 зберігся, гібридний бал вищий — BM25 підтверджує релевантність |
| What is a Git branch and how do I create one? | gitlab_getting_started_chunk_010 (0.6182) | git_about_version_control_chunk_001 (0.9777) | 🔄 Гібридний пошук обрав інший чанк: gitlab_getting_started_chunk_010 → git_about_version_control_chunk_001 |
| How to resolve merge conflicts in Git? | branching_basic_branching_merging_chunk_013 (0.7696) | branching_basic_branching_merging_chunk_009 (0.9453) | 🔄 Гібридний пошук обрав інший чанк: branching_basic_branching_merging_chunk_013 → branching_basic_branching_merging_chunk_009 |
...
| How do I merge a branch in GitLab? | gitlab_getting_started_chunk_007 (0.7459) | gitlab_getting_started_chunk_006 (0.9230) | 🔄 Гібридний пошук обрав інший чанк: gitlab_getting_started_chunk_007 → gitlab_getting_started_chunk_006 |
...
| How do I push changes to a remote repository? | gitlab_getting_started_chunk_011 (0.7247) | gitlab_getting_started_chunk_011 (0.9291) | ✅ Топ-1 зберігся, гібридний бал вищий — BM25 підтверджує релевантність |
...
**Improved (HW3):** `git_basics_getting_repository_chunk_006` (0.9877)

### Запит 2: What is a Git branch and how do I create one?

**Baseline (HW2):** `gitlab_getting_started_chunk_010` (0.6182)
**Improved (HW3):** `git_about_version_control_chunk_001` (0.9777)

### Запит 3: How to resolve merge conflicts in Git?

**Baseline (HW2):** `branching_basic_branching_merging_chunk_013` (0.7696)
**Improved (HW3):** `branching_basic_branching_merging_chunk_009` (0.9453)
...
**Improved (HW3):** `gitlab_getting_started_chunk_006` (0.9230)
...
**Improved (HW3):** `gitlab_getting_started_chunk_011` (0.9291)
