...
| What is the difference between git add and git commit? | github_about_git_chunk_007 (0.6455) | git_basics_getting_repository_chunk_003 (0.9308) | 🔄 Гібридний пошук обрав інший чанк: github_about_git_chunk_007 → git_basics_getting_repository_chunk_003 |
...
| How do I merge a branch in GitLab? | gitlab_getting_started_chunk_004 (0.7394) | gitlab_getting_started_chunk_003 (0.9361) | 🔄 Гібридний пошук обрав інший чанк: gitlab_getting_started_chunk_004 → gitlab_getting_started_chunk_003 |
| How do I view the commit history? | github_about_git_chunk_000 (0.5553) | git_tools_rebasing_chunk_016 (0.9791) | 🔄 Гібридний пошук обрав інший чанк: github_about_git_chunk_000 → git_tools_rebasing_chunk_016 |
...
| How do I push changes to a remote repository? | distributed_workflows_chunk_005 (0.7182) | distributed_workflows_chunk_005 (0.9020) | ✅ Топ-1 зберігся, гібридний бал вищий — BM25 підтверджує релевантність |
...
**Baseline (HW2):** `github_about_git_chunk_007` (0.6455)
**Improved (HW3):** `git_basics_getting_repository_chunk_003` (0.9308)
...
**Improved (HW3):** `gitlab_getting_started_chunk_003` (0.9361)

### Запит 7: How do I view the commit history?

**Baseline (HW2):** `github_about_git_chunk_000` (0.5553)
**Improved (HW3):** `git_tools_rebasing_chunk_016` (0.9791)
...
**Improved (HW3):** `distributed_workflows_chunk_005` (0.9020)
