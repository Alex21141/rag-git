...
| What is a Git branch and how do I create one? | gitlab_getting_started_chunk_001 (0.6397) | git_about_version_control_chunk_002 (0.9615) | 🔄 Гібридний пошук обрав інший чанк: gitlab_getting_started_chunk_001 → git_about_version_control_chunk_002 |
...
**Baseline (HW2):** `gitlab_getting_started_chunk_001` (0.6397)
**Improved (HW3):** `git_about_version_control_chunk_002` (0.9615)
