...
**Висновки:**
- Гібридний пошук стабілізує retrieval — навіть якщо семантична модель «губиться» в загальних чанках, BM25 повертає релевантні чанки з точним співпадінням ключових слів
